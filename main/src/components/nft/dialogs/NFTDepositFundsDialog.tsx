...
import { INFTDepositFundsDialog } from '../../../types/dialogs'
...
export default function NFTDepositFundsDialog({ contractAddress, isOpen, openModal, closeModal }: INFTDepositFundsDialog) {

    const NFTStakingContracts = new Contract(contractAddress, ERC20Staking.abi)

    const { state: stateDepositFunds, send: depositFunds } = useContractFunction(NFTStakingContracts, 'depositFunds', { transactionName: 'Deposit Funds' })
