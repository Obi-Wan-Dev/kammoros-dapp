...
interface ICreateRoundDialog {
    startTime: number
    duration: number
}

export default function CreateRoundButton({ startTime, duration }: ICreateRoundDialog) {
    ...
    return (
        <>
            ...
            <div>{isOpen}</div>
            <CreateRoundDialog startTime={startTime} duration={duration} isOpen={isOpen} openModal={openModal} closeModal={closeModal} />
        </>
    )
}