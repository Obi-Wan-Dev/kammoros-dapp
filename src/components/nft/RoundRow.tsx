...
export default function RoundRow({ contractAddress, index }: IRoundRow) {
    ...
    const countDepositsForRoundByAddress = useCountDepositsForRoundByAddress(contractAddress, index, address)
    const weightedAverageForRoundByAddress = useWeightedAverageForRoundByAddress(contractAddress, index, address)

    const ethAllocForRoundByAddress = useETHAllocForRoundByAddress(contractAddress, index, address)
    const ethClaimedForRoundByAddress = useETHClaimedForRoundByAddress(contractAddress, index, address)
    const ethUnclaimedForRoundByAddress = useETHUnclaimedForRoundByAddress(contractAddress, index, address)
