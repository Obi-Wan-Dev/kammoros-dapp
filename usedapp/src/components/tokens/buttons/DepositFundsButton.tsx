...
import DepositFundsDialog from "../dialogs/DepositFundsDialog"

interface IDepositFundsDialog {
    roundIndex: number,
    amount: string,
}

export default function CreateRoundButton({ roundIndex, amount }: IDepositFundsDialog) {
    ...
    return (
        <>
            ...
            <div>{isOpen}</div>
            <DepositFundsDialog roundIndex={roundIndex} amount={amount} isOpen={isOpen} openModal={openModal} closeModal={closeModal} />
        </>
    )
}