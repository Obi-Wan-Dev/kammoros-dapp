...
import RescueDepositDialog from "../dialogs/RescueDepositDialog"

interface IRescueDepositDialog {
    depositIndex: string,
}

export default function RescueDepositButton({ depositIndex }: IRescueDepositDialog) {
    ...
    return (
        <>
            ...
            <div>{isOpen}</div>
            <RescueDepositDialog depositIndex={depositIndex} isOpen={isOpen} openModal={openModal} closeModal={closeModal} />
        </>
    )
}